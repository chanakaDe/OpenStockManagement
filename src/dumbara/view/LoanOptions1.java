 ...
 * @author ChanakaDe
 */
public class LoanOptions1 extends javax.swing.JDialog {

    /**
     * Creates new form LoanOptions1
     */
    public LoanOptions1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
            ...
            LoanOptionSetCount[] loanOptionsMs=LoanOptionSetcountController.viewLoanOptionSetCounts();
                ...
                r1.setText(loanOptionsMs[0].getCount()+"");
                r2.setText(loanOptionsMs[1].getCount()+"");
                r3.setText(loanOptionsMs[2].getCount()+"");
                r4.setText(loanOptionsMs[3].getCount()+"");
                r5.setText(loanOptionsMs[4].getCount()+"");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Set Loan count");
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ArrayList<LoanOptionSetCount> arrayList=new ArrayList<>();
        String id;
        double lowest;
        double highest;
        double rate;
        ...
        LoanOptionSetCount loanOptionSetCount=new LoanOptionSetCount(id, lowest, highest, rate);
        arrayList.add(loanOptionSetCount);
        ...
        loanOptionSetCount=new LoanOptionSetCount(id, lowest, highest, rate);
        arrayList.add(loanOptionSetCount);
        ...
        arrayList.add(loanOptionSetCount);
            ...
            try {
            try {
                res = LoanOptionSetcountController.addLoanOptionSetCount(arrayList);
            } catch (SQLException ex) {
                Logger.getLogger(LoanOptions1.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        arrayList.add(loanOptionSetCount);
        try {
            int updateLoanOption = LoanOptionSetcountController.updateLoanOption(arrayList);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoanOptions1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LoanOptions1 dialog = new LoanOptions1(new javax.swing.JFrame(), true);
